...
static struct RegisterParameters ax = {START_VALUE, AX_STR, AX};
static struct RegisterParameters bx = {START_VALUE, BX_STR, BX};
static struct RegisterParameters cx = {START_VALUE, CX_STR, CX};
static struct RegisterParameters dx = {START_VALUE, DX_STR, DX};
